...
export class KyberBase {
  ...
  protected _compressU(_r: Uint8Array, _u: Array<Array<number>>): Uint8Array {
    throw new Error("Use Kyber512/768/1024.");
  }

  // compress2 lossily compresses and subsequently serializes a polynomial.
  protected _compressV(_r: Uint8Array, _v: Array<number>): Uint8Array {
    throw new Error("Use Kyber512/768/1024.");
  }
  ...
  protected _decompressU(_a: Uint8Array): Array<Array<number>> {
    throw new Error("Use Kyber512/768/1024.");
  }
  ...
  // original input.
  protected _decompressV(_a: Uint8Array): Array<number> {
    throw new Error("Use Kyber512/768/1024.");
  }
}
